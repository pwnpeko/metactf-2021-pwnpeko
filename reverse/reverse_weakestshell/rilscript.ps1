Set-Variable -Name nU0 -Value (systEm.seCUrITY.CrYPTogrApHy.hAshAlgoRIThM)  ;Set-Variable -Name Clob -Value (SysteM.bitcOnVeRtEr) ;  SET-iTeM  vaRiabLe:OMz  (SYSTEM.convERT);    SEt-ITEM vARIABlE:pO52Ew (sYstEM.teXt.eNcOdINg) ;sEt-itEm  (variaBLE:2L36D)  (sTrinG)  ;  function wFKh(${STR}) {
...
if (${iNPUT}."leNGTh" -eq 39) {
    ...
    ${pArt2} =   (  GeT-vaRiaBLE ("2l3"+"6d") -valUeoNlY )::"jOiN"("", ${inPUt}[13..25])
